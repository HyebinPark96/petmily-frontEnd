...
const tableIcons = {
  ...
  Delete: forwardRef((props, ref) => (
    <icon1.DeleteOutline {...props} ref={ref} />
  )),
  DetailPanel: forwardRef((props, ref) => (
    <icon1.ChevronRight {...props} ref={ref} />
  )),
        ...
        actions={[
          {
            ...
            onClick: (event, rowData) =>
              openPostRelatedDialog(rowData.no, "READ"),
          },
          {
            icon: DeleteIcon,
            onClick: (event, rowData) =>
              openPostRelatedDialog(rowData.no, "CHECKPWD_DELETE"),
          },
          {
            icon: CreateIcon,
            onClick: (event, rowData) =>
              openPostRelatedDialog(rowData.no, "CHECKPWD_UPDATE"),
          },
          {
            icon: AddIcon,
            isFreeAction: true,
