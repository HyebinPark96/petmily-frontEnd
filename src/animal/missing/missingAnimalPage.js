...
const MissingAnimalPage = () => {
  ...
  const getMissingAnimalList = async() => {
    ...
    await axios.get(`https://apis.data.go.kr/1543061/abandonmentPublicSrvc/abandonmentPublic?_type=json&pageNo=1&numOfRows=10&serviceKey=${process.env.REACT_APP_API_KEY}`)
    .then((result) => {
